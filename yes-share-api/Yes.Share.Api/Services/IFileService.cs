...
public interface IFileService
{
    ...
    Task AppendChunkAsync(string uploadId, Stream chunkStream, int uploaderId);
    Task<ChunkUploadStatusResponse> GetChunkUploadStatusAsync(string uploadId, int uploaderId);
    Task CancelChunkUploadAsync(string uploadId, int uploaderId);
